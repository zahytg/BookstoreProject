    ...
    <div className="container mt-5 mb-5">
      ...
      <div className="row">
        ...
        <div className="col-lg-3 mb-4">
          {/* Profile Card */}
          <div className="card shadow-sm border-0 text-center mb-3" style={{ borderRadius: '12px' }}>
            <div className="card-body p-4">
              <div className="mb-3">
                <div className="rounded-circle bg-light d-inline-flex align-items-center justify-content-center" 
                  style={{ width: '100px', height: '100px', backgroundColor: '#5cbdb0 !important' }}>
                  <i className="bi bi-person" style={{ fontSize: '3rem', color: '#5cbdb0' }}></i>
                </div>
              </div>
              <h5 className="fw-bold mb-1">{user?.name || 'Người dùng'}</h5>
              <p className="text-muted mb-0" style={{ fontSize: '14px' }}>{user?.email}</p>
            </div>
          </div>
          ...
          <div className="card shadow-sm border-0" style={{ borderRadius: '12px' }}>
            <div className="list-group list-group-flush">
              <button 
                className={`list-group-item list-group-item-action d-flex align-items-center gap-2 py-3 ${activeTab === 'info' ? 'active' : ''}`}
              ...
              >
                <i className="bi bi-person-gear"></i> Thông tin tài khoản
              </button>
              <button 
                className={`list-group-item list-group-item-action d-flex align-items-center gap-2 py-3 ${activeTab === 'favorites' ? 'active' : ''}`}
              ...
              >
                ...
                <span className="badge bg-secondary ms-auto">{favorites.length}</span>
              </button>
              <button 
                className={`list-group-item list-group-item-action d-flex align-items-center gap-2 py-3 ${activeTab === 'vouchers' ? 'active' : ''}`}
              ...
              >
                <i className="bi bi-ticket-perforated"></i> Voucher của tôi 
                <span className="badge bg-secondary ms-auto">{vouchers.length}</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-9">
          {/* Statistics Cards */}
          <div className="card shadow-sm border-0 mb-4" style={{ borderRadius: '12px', backgroundColor: '#fafafa' }}>
            <div className="card-body p-4">
              <h6 className="text-muted mb-4 fw-bold">
                <i className="bi bi-graph-up me-2"></i>Tổng quan tài khoản
              </h6>
              
              <div className="row g-4">
                {/* Card 1: Ưu đãi của bạn */}
                <div className="col-md-6">
                  <div className="card shadow-sm border-0 h-100" style={{ borderRadius: '12px', backgroundColor: 'white' }}>
                    <div className="card-body p-4">
                      ...
                      <div className="row">
                        <div className="col-6">
                          <div className="mb-3">
                            <small className="text-muted d-block mb-2" style={{ fontSize: '13px' }}>Yêu thích hiện có</small>
                            <h2 className="text-danger mb-0 fw-bold" style={{ fontSize: '2.5rem' }}>{favorites.length}</h2>
                          </div>
                        </div>
                        <div className="col-6">
                          <div className="mb-3">
                            <h2 className="text-success mb-0 fw-bold" style={{ fontSize: '2.5rem' }}>0</h2>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 pt-3 border-top">
                        <small className="text-muted d-block mb-2" style={{ fontSize: '13px' }}>
                          <i className="bi bi-ticket me-1"></i>Voucher của bạn
                        </small>
                  ...
                  <div className="card shadow-sm border-0 h-100" style={{ borderRadius: '12px', backgroundColor: 'white' }}>
                    <div className="card-body p-4">
                      ...
                      <div className="row">
                        <div className="col-6">
                          <div className="mb-3">
                            <small className="text-muted d-block mb-2" style={{ fontSize: '13px' }}>Số đơn hàng</small>
                            <h2 className="text-primary mb-0 fw-bold" style={{ fontSize: '2.5rem' }}>{totalOrders}</h2>
                          </div>
                        </div>
                        <div className="col-6">
                          <div className="mb-3">
                            <small className="text-muted d-block mb-2" style={{ fontSize: '13px' }}>Đã thanh toán</small>
                            <h2 className="text-success mb-0 fw-bold" style={{ fontSize: '2rem' }}>{totalPaid.toLocaleString('vi-VN')}</h2>
                            <small className="text-muted" style={{ fontSize: '13px' }}>đ</small>
                          </div>
                        </div>
                      </div>
                      
                      {/* ✅ XÓA PROGRESS BAR - Không còn mục tiêu năm */}
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <div className="card border-0 shadow-sm" style={{ 
                          ...
                          <div className="card-body p-4" style={{ position: 'relative', zIndex: 1 }}>
                            <div className="d-flex justify-content-between align-items-center mb-3">
                              ...
                              <span className="badge bg-white text-primary" style={{ fontSize: '12px' }}>{voucher.discount}</span>
                            </div>
