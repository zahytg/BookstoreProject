...
export default function BookDetail({ token: propToken }) {
  ...
  // Sample reviews data
  const sampleReviews = {
    '69c5814c2b4906d053cc81d5': [
      { user: 'Nguyễn Văn A', rating: 5, comment: 'Truyện rất hay, nội dung hấp dẫn!', date: '2026-03-25' },
      { user: 'Trần Thị B', rating: 4, comment: 'Hình vẽ đẹp, cốt truyện lôi cuốn', date: '2026-03-20' }
    ],
    '69c5814c2b4906d053cc81d8': [
      { user: 'Lê Văn C', rating: 5, comment: 'Tuổi thơ dữ dội, mua cho con đọc', date: '2026-03-28' }
    ]
  }
  ...
  useEffect(() => {
    const fetchBook = async () => {
      try {
        ...
        const bookReviews = sampleReviews[res.data._id] || []
          ...
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              <div className="mb-3">
                ...
                <p className="lead fw-bold" style={{ color: '#28a745', fontSize: '1.8rem' }}>
              ...
              <div className="row mb-4">
                <div className="col-md-6">
                  <h6 className="fw-bold mb-2" style={{ color: '#5cbdb0' }}>
                    <i className="bi bi-folder me-2"></i>Danh mục
                  </h6>
                  <p className="text-muted">{book.category?.name || 'Chưa có danh mục'}</p>
                </div>
                <div className="col-md-6">
                  <h6 className="fw-bold mb-2" style={{ color: '#5cbdb0' }}>
                    <i className="bi bi-building me-2"></i>Nhà xuất bản
                  </h6>
              ...
              <div className="mb-4">
                <h6 className="fw-bold mb-2" style={{ color: '#5cbdb0' }}>
                  <i className="bi bi-file-text me-2"></i>Mô tả sách
                </h6>
                <p className="text-muted">
                  ...
                  {description.length > 150 && (
                    <button 
                      ...
                      style={{ color: '#5cbdb0', textDecoration: 'none' }}
              ...
              <div className="d-flex gap-3 flex-wrap">
                ...
                <button 
                  className={`btn btn-lg fw-bold px-4 ${isFavorite ? 'btn-danger' : 'btn-outline-danger'}`}
                ...
                <button 
                  className="btn btn-lg fw-bold px-4 btn-outline-secondary"
                  style={{ borderRadius: '10px' }}
                ...
                <Link to="/" className="btn btn-lg fw-bold px-4 btn-outline-secondary" style={{ borderRadius: '10px' }}>
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-2">
                              <div>
                                <h6 className="mb-0 fw-bold">
                                  <i className="bi bi-person-circle me-2" style={{ color: '#5cbdb0' }}></i>
                                  {review.user}
                                </h6>
