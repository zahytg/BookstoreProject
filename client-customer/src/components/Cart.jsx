  ...
  if (!token) {
    return (
      <div className="card shadow-lg border-0 text-center p-5" style={{ borderRadius: '15px' }}>
        ...
        <h3 className="mt-3 mb-3">Bạn cần đăng nhập</h3>
        <p className="text-muted mb-4">Vui lòng đăng nhập để xem giỏ hàng</p>
  ...
  return (
    <div className="container mt-5 mb-5">
      <h2 className="mb-5 fw-bold text-center" style={{ color: '#5cbdb0' }}>
        <i className="bi bi-cart me-2"></i>Giỏ hàng của bạn
      </h2>
